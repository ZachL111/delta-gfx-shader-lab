...
`delta-gfx-shader-lab` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for shader systems, covering format conversion, round-trip fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 179. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 5.
