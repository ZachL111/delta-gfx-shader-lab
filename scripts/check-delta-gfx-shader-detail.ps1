...
$repo = "delta-gfx-shader-lab"
$language = "Dart"
$category = "Graphics"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/delta-gfx-shader-walkthrough.md")) {
