"""Regression checks for the delta-gfx-shader-lab casebook."""
...
from casebook.harness import assert_expected, delta_gfx_shader_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_gfx_shader_lab_summary(), assert_expected())
